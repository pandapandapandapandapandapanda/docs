...
<Card title="Publish to RoScripts" icon="upload" href="https://roscripts.io/upload">
  Once your script is ready, list it on **RoScripts** so players can find it. Free, takes a minute, and Rayfield-built scripts get a small ranking boost.
</Card>
